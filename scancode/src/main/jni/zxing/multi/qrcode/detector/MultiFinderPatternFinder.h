...
namespace zxing {
    namespace multi {
        ...
        class MultiFinderPatternFinder : zxing::scancode::FinderPatternFinder {
        private:
            std::vector<std::vector<Ref<zxing::scancode::FinderPattern> > > selectBestPatterns();
        ...
        public:
            ...
            virtual std::vector<Ref<zxing::scancode::FinderPatternInfo> > findMulti(
